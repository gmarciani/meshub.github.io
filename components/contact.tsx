...
const Contact = () => {
  ...
  // Move contactInfo here so onSubmit can reference it
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      content: 'support@meshub.us',
    },
    {
      icon: Phone,
      title: 'Phone',
      content: '+1 (857) 233-23369',
    },
    {
      icon: MapPin,
      title: 'Address',
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    const recipient = contactInfo.find((i) => i.title === 'Email')?.content ?? 'support@meshub.us';
    ...
    <section id="contact" className="py-24 bg-zinc-50 dark:bg-zinc-950 border-b border-border/50">
      <div className="container mx-auto px-6">
        ...
        <motion.div 
          ...
          <CustomSubtitle>
            Have questions or ready to get started with Meshub ?<br />
