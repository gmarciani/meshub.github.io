...
const Hero = () => {
  ...
  const rotatingWords = ["Justice", "Legislation", "Demographics", "Firmographics"];
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <Link href="#call-to-action">
              <Button size="lg" className="cursor-pointer hover:[&_svg]:translate-x-1 w-46 flex items-center gap-2">
                Join the Beta
          ...
          {/* Hero Video Dialog - Commented Out */}
          {/* <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
