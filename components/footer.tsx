...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: X, href: 'https://x.com/giacomomarciani', label: 'X (Twitter)' },
    { icon: Github, href: 'https://github.com/gmarciani', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/giacomomarciani', label: 'LinkedIn' },
    { icon: Mail, href: 'mailto:support@meshub.us', label: 'Email' }
  ];
      ...
      <div className="container px-6 mx-auto pt-14 pb-6 border-b border-border/50">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2025 Meshub. All rights reserved.
          </p>
          <p className="text-muted-foreground text-sm mt-4 md:mt-0">
            Product by <a href="https://github.com/gmarciani" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-indigo-600 hover:underline">GMARCIANI</a>
          </p>
        </div>
      </div>
    </footer>
